...
- **Outline version:** v1.0 - 2026-07-14
- **Status:** draft
...
| ARG-19 | Boundary conditions mapped: chain-length gradient (E7 - LANDED 2026-07-14: no crossover exists; benefit grows with chain length and headroom; source calibration fails), pricing asymmetry (E8, outstanding), hysteresis split (E9, outstanding), and the recipe-level non-stationarity limitation (E12, outstanding - E7 has pre-figured it: spurious damping at iid_control produces resolved benefit, hinting the value may come from damping per se rather than the phi-recipe) | 6.5, App F | ARG-14 | LB-E7-gradient, LB-E7-calibration, LB-E8-up, LB-E8-down, LB-E9-robust, LB-E9-fragile, LB-E12-oracle, TBL-7, Boute-2022 | TRANSFORM (partial - E7 leg landed) |
...
| LB-E7-gradient | Chain-length sweep: the all-tier deployment gradient across chain length and capacity headroom, and the ABSENCE of any harm region. [RENAMED 2026-07-14 from LB-E7-crossover - the old name presumed a crossover that does not exist.] VALUE: 29/36 cells resolved vs zero - 0 harm, 29 benefit, 7 unresolved. Benefit grows with chain length (ar1_high x 2.4x: -0.6767% L=4 / -0.9369% L=6 / -1.6783% L=8) and with headroom (ar1_high x L=4: -0.0636% 1.3x / -0.3478% 1.8x / -0.6767% 2.4x). No grid line spans a resolved harm->benefit transition, so no crossover is locatable. Exception recorded: cap=1.3 x L=6 is a dead zone (all four environments unresolved). | ARG-19 | DONE |
| LB-E7-calibration | Estimate-vs-source on the source's three published chain-length point-predictions (ar1_high x 2.4x). VALUE 2026-07-14: source +0.44% / +0.14% / -0.14% at L=4/6/8 vs ours -0.6767% [-0.7376,-0.6159] / -0.9369% [-1.0579,-0.8159] / -1.6783% [-1.8775,-1.4791]. ALL THREE source values fall OUTSIDE our CI; sign disagrees at L=4 and L=6; the L=8 agreement is hollow (both negative, ours 12x larger). The source's crossover does not reproduce. Direction (benefit grows with length) reproduces; LEVEL does not. | ARG-19 | DONE |
