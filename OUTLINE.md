...
- **Outline version:** v1.1 - 2026-07-15
- **Status:** draft
...
| ARG-19 | Boundary conditions mapped: chain-length gradient (E7 - PENDING: the 2026-07-14 result is WITHDRAWN as a build defect, not a source failure; rebuild frozen at 2a20877 and running, 250 seeds x 5 variants on the vendored source construction - see DESIGN 14d/14e/14f and DISC-05), pricing asymmetry (E8, not opened - does not open until E7 is finished and closed), hysteresis split (E9, outstanding), and the recipe-level non-stationarity limitation (E12, outstanding - it rides on E7's rebuild, whose three-variant diagnostic is where the source discovered it; the withdrawn 2-scenario scoping had severed this) | 6.5, App F | ARG-14 | LB-E7-gradient, LB-E7-calibration, LB-E8-up, LB-E8-down, LB-E9-robust, LB-E9-fragile, LB-E12-oracle, TBL-7, Boute-2022 | TRANSFORM (E7 leg PENDING re-run) |
...
| LB-E7-gradient | Chain-length sweep: the all-tier deployment gradient across chain length and capacity headroom. PENDING RE-RUN 2026-07-15. The 2026-07-14 values (29/36 resolved; 0 harm, 29 benefit; ar1_high x 2.4x -0.6767%/-0.9369%/-1.6783%) are WITHDRAWN - they measure a construction the frozen operator did not authorize (E4's calibration where the operator said "source calibration"; see DISC-05). They were real measurements of the wrong experiment and re-earn nothing. Rebuild frozen at 2a20877, running: vendored source construction, 250 seeds, 5 variants, sr_paper9_ols vs sr_disabled paired per seed. FOR REFERENCE while pending - the SOURCE's own 36 cells at their 50 seeds, recomputed from their 9,000-trial artifact: only 15 of 36 RESOLVE (8 harm, 7 benefit, 21 unresolved); iid_control resolves 0 of 9 (the no-harm property holds); ar1_moderate resolves 6 of 9 and every one is BENEFIT (to -0.209%, 11.7 sigma); ar1_high resolves 3 of 9 and every one is HARM. | ARG-19 | PENDING (re-run in progress) |
| LB-E7-calibration | RENAMED IN PURPOSE 2026-07-15 and PENDING. The 2026-07-14 node asserted "estimate-vs-source... the source's crossover does not reproduce; all three source values outside our CI; sign disagrees at L=4 and L=6" - THAT IS FALSE and is WITHDRAWN. The source is faithful: their published +0.44/+0.14/-0.14 recompute to +0.439/+0.137/-0.141 directly from their own artifact, and their code clears all seven CIC classes. Under the rebuild there is no calibration leg at all (DESIGN 14e): we run THEIR construction, so agreement is expected and is a regression check, not evidence. What this node will carry instead is the RESOLUTION comparison on the headline line (ar1_high x 2.4x): the source's own SEs are 0.072/0.078/0.081, so L=4 resolves at 6.1 sigma but L=6 (+0.137, 1.8 sigma) and L=8 (-0.141, 1.7 sigma) DO NOT - their headline crossover from harm to benefit rests on two readings indistinguishable from zero, and their own record calls it "the chain-length effect we hoped to find." At 250 seeds both project to ~3.9 sigma, so the rebuild adjudicates what their design could not. | ARG-19 | PENDING (re-run in progress) |
