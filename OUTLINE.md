...
- **Outline version:** v0.7 - 2026-07-13
- **Status:** draft
...
| ARG-20 | The two sectors the CHIPS Act depends on rank as the most structurally unstable in the panel (graded assertion per DESIGN E5, AMENDED to rank on mean exceedance). STATUS 2026-07-13: UNTESTED / INCONCLUSIVE pending redesigned run. The first run's '% months rho > 1' ranking key SATURATED (six-way tie at 100% under SPEC-R) and could not adjudicate #1-#2 in either direction - that run is INCONCLUSIVE, not a result. Primary key redesigned to mean exceedance (non-saturating); re-run pending. The claim is neither asserted nor refuted at this point. | 7.1 | ARG-15 | LB-E5-ranking, LB-E5-chips, TBL-4, Monch-2011 | PENDING (re-run on mean exceedance) |
...
| LB-E5-ranking | 17-sector instability ranking. AMENDED 2026-07-13 to rank on mean exceedance (was '% months rho > 1', which saturated: SPEC-R top six AMTMIS/AMDMIS/AMNMIS/A34SIS/A31SIS/R4233 all ~100% months - the saturation that invalidated the first ranking). Mean-exceedance re-run PENDING. | ARG-20 | PENDING |
| LB-E5-chips | Rank positions of the two CHIPS-dependent sectors (graded assertion rule on mean exceedance). First-run '% months' ranks (A34SIS #4/#10, R4238 #8/#9) are INCONCLUSIVE (saturation artifact, not a measurement). Re-run PENDING. | ARG-20 | PENDING |
...
| C-05 | The CHIPS-dependent sectors rank at the top of the structural-instability panel (graded per E5 rule, amended to mean exceedance). STATUS 2026-07-13: UNTESTED pending the redesigned run (first run inconclusive - saturation). | 11 | PENDING |
