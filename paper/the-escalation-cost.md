...
| --- | --- | --- | --- |
| retail to wholesale | {{LB-E14-chain-full-s1-ratio}} [{{LB-E14-chain-full-s1-lo}}, {{LB-E14-chain-full-s1-hi}}] | {{LB-E14-chain-excl-s1-ratio}} [{{LB-E14-chain-excl-s1-lo}}, {{LB-E14-chain-excl-s1-hi}}] | {{LB-E14-arm-s1-ratio}} [{{LB-E14-arm-s1-lo}}, {{LB-E14-arm-s1-hi}}] |
| wholesale to shipments | {{LB-E14-chain-full-s2-ratio}} [{{LB-E14-chain-full-s2-lo}}, {{LB-E14-chain-full-s2-hi}}] | {{LB-E14-chain-excl-s2-ratio}} [{{LB-E14-chain-excl-s2-lo}}, {{LB-E14-chain-excl-s2-hi}}] | {{LB-E14-arm-s2-ratio}} [{{LB-E14-arm-s2-lo}}, {{LB-E14-arm-s2-hi}}] |
| shipments to new orders | {{LB-E14-chain-full-s3-ratio}} [{{LB-E14-chain-full-s3-lo}}, {{LB-E14-chain-full-s3-hi}}] | {{LB-E14-chain-excl-s3-ratio}} [{{LB-E14-chain-excl-s3-lo}}, {{LB-E14-chain-excl-s3-hi}}] | {{LB-E14-arm-s3-ratio}} [{{LB-E14-arm-s3-lo}}, {{LB-E14-arm-s3-hi}}] |
| compound product of steps | {{LB-E14-chain-full-compound}} | {{LB-E14-chain-excl-compound}} | {{LB-E14-arm-compound}} |
| direct end-to-end ratio | {{LB-E14-chain-full-e2e}} | {{LB-E14-chain-excl-e2e}} | {{LB-E14-arm-e2e}} |
| discrepancy, compound minus end-to-end | {{LB-E14-chain-full-identity}} | {{LB-E14-chain-excl-identity}} | - |
...
**The pre-registered rule did not fire, and it could not have.** Our registered decision rule declared separation only when one step's interval lower bound cleared every other step's interval upper bound; on the registered chain it returned {{LB-E14-chain-full-result}} on the full sample and {{LB-E14-chain-excl-result}} excluding COVID. Two things must be said about that, and the first is uncomfortable. Measured afterwards at the coupling the data actually exhibits, the detection probability of that rule at the effect size we observed on the full sample was {{LB-E14-severity-full-power-at-full-effect}}; at the COVID-excluded effect size it was {{LB-E14-severity-excl-power-at-excl-effect}}. The full-sample pass therefore carries no information: it is the outcome the rule would have produced whether or not a concentration of that magnitude is real. The smallest ordering-step ratio the rule resolves at 80 percent recovery is {{LB-E14-severity-full-r3-at-80}} on the full sample and {{LB-E14-severity-excl-r3-at-80}} excluding COVID - both above what we measured. Reassuringly, the same characterization puts the rule's false-positive rate at {{LB-E14-severity-full-fpr}} and {{LB-E14-severity-excl-fpr}} when no concentration is planted, so it does not manufacture structure; it simply could not see this much of it. For completeness the cross-configuration cells are {{LB-E14-severity-full-power-at-excl-effect}} and {{LB-E14-severity-excl-power-at-full-effect}}.
...
| --- | --- | --- | --- | --- |
| Full sample | {{LB-E14-contrast-full-point}} [{{LB-E14-contrast-full-lo}}, {{LB-E14-contrast-full-hi}}] | {{LB-E14-contrast-full-argmax-top}} | {{LB-E14-contrast-full-argmax-mid}} | {{LB-E14-contrast-power-full}} |
| Excluding COVID | {{LB-E14-contrast-excl-point}} [{{LB-E14-contrast-excl-lo}}, {{LB-E14-contrast-excl-hi}}] | {{LB-E14-contrast-excl-argmax-top}} | {{LB-E14-contrast-excl-argmax-mid}} | {{LB-E14-contrast-power-excl}} |
| Durable-goods arm | {{LB-E14-contrast-arm-point}} [{{LB-E14-contrast-arm-lo}}, {{LB-E14-contrast-arm-hi}}] | {{LB-E14-contrast-arm-argmax-top}} | {{LB-E14-contrast-arm-argmax-mid}} | not characterized |

Under this statistic the ordering step separates in all three configurations, and the middle step is never the largest in any resample of any configuration. The honest weighting is this: the COVID-excluded reading is the sound one, with power at its observed effect of {{LB-E14-contrast-power-excl}}; the full-sample reading fired at a configuration whose power is only {{LB-E14-contrast-power-full}}, and a single result obtained where the rule fires roughly a third of the time is fragile and should not be presented as strong. The durable-goods arm separated under both the pre-registered rule and the contrast, but its coupling regime was never power-characterized, so no power figure attaches to it and it rests on the pre-registered rule's zero false-positive rate.

The claim we are willing to defend, therefore, is that amplification **concentrates at the ordering step** - not that we have proven it. And the scope condition (S-1) binds with full force here: this analysis locates *where* amplification concentrates. It does not establish that the measurement mechanism *caused* the concentration. Concentration at the point where firms convert observed demand into orders is consistent with the mechanism this paper models, and it does not exclude the batching, rationing, and promotional channels the classical literature describes.
...
One operational consequence follows and is easy to miss. The window is not always an available lever. At the persistence levels the manufacturing panel actually exhibits, shortening the measurement window does not bring the loop back inside the boundary - the persistence is simply too high for a window-based fix - and only reducing feedback aggressiveness moves the spectral radius meaningfully. An institution that responds to a boundary warning by measuring faster may find it has spent effort on the lever that does not move.
