...
Two derived quantities make the criterion operational. The stability margin M = 1 - S(phi, W) * bg / (pi^2/2) measures the fractional distance from the boundary - one at zero feedback, zero at the limit - and the maximum safe aggressiveness bg_max = (pi^2/2) / S(phi, W) is the same criterion solved for the feedback gain: the largest ordering aggressiveness the current persistence and window admit. Both are rearrangements of EQ-5 rather than new results, reported because they are the forms a practitioner reads off a dashboard - how much room is left, and how hard the system may push.
...
<!-- anchor: EQ-6 -->
EQ-6 gives the optimal safety factor k*, approximately 1 - (1 / (pi^2/2)) * sqrt(2 * p * W * Var(phi_hat)), where p is the per-period regime-change probability and Var(phi_hat) the persistence-estimation variance. The structure of the expression carries the intuition: every quantity under the root is a source of blindness risk - likelier regime changes, longer windows, noisier estimates - and each pushes the safe operating point further below the limit. Under regime-change risk the optimal operating point sits below the limit: mfg-parameter argmin {{LB-T3-kstar-mfg-argmin}}, in-band {{LB-T3-kstar-inband}}, all-below-one {{LB-T3-kstar-allbelow1}}, verdict {{LB-T3-kstar-verdict}} (proposition-level: numeric legs here; the written proof with labeled approximations is P-THM-3's companion obligation in Appendix G).
...
| Paired contrast: D minus crisis rho | {{LB-E2-contrast-rho}} |
| Paired contrast p (one-sided) | {{LB-E2-contrast-rho-p}} |
| Paired contrast reading | {{LB-E2-contrast-rho-reading}} |
| Paired contrast: D minus abs delta phi | {{LB-E2-contrast-dphi}} |
| Paired contrast p (one-sided) | {{LB-E2-contrast-dphi-p}} |
...
**The pre-registered rule did not fire, and it could not have.** Our registered decision rule declared separation only when one step's interval lower bound cleared every other step's interval upper bound; on the registered chain it returned {{LB-E14-chain-full-result}} on the full sample and {{LB-E14-chain-excl-result}} excluding COVID. Two things must be said about that, and the first is uncomfortable. Measured afterwards, in an exploratory characterization at the coupling the data actually exhibits, the detection probability of that rule at the effect size we observed on the full sample was {{LB-E14-severity-full-power-at-full-effect:.2f}}; at the COVID-excluded effect size it was {{LB-E14-severity-excl-power-at-excl-effect:.2f}}. The full-sample pass therefore carries no information: it is the outcome the rule would have produced whether or not a concentration of that magnitude is real. The smallest ordering-step ratio the rule resolves at 80 percent recovery is {{LB-E14-severity-full-r3-at-80:.1f}} on the full sample and {{LB-E14-severity-excl-r3-at-80:.1f}} excluding COVID - both above what we measured. Reassuringly, the same characterization puts the rule's false-positive rate at {{LB-E14-severity-full-fpr:.2f}} and {{LB-E14-severity-excl-fpr:.2f}} when no concentration is planted, so it does not manufacture structure; it could not see this much of it. For completeness the cross-configuration cells are {{LB-E14-severity-full-power-at-excl-effect:.2f}} and {{LB-E14-severity-excl-power-at-full-effect:.2f}}.
...
*Table TBL-4. Seventeen-sector cross-section, ranked by SPEC-R mean exceedance (the amended primary key). Share is the fraction of months rho > 1 under SPEC-R - near one for most sectors, the saturation record. Under SPEC-M the same instrument floors instead: {{LB-E5-specm-zero-exceedance-count}} of seventeen sectors tie at exactly zero mean exceedance, so SPEC-M orders only the crossing sectors and the ranking claim of Section 8.1 is a SPEC-R claim (C-05). Episode columns are the SPEC-M monitoring record (Section 7.4): status in the onset +/- 24-month window and the first upward-crossing month ("none" where no crossing occurred). CHIPS footnote: ranks R4238 {{LB-E5-chips-rank-R-R4238}} (SPEC-R) / {{LB-E5-chips-rank-M-R4238}} (SPEC-M), A34SIS {{LB-E5-chips-rank-R-A34SIS}} / {{LB-E5-chips-rank-M-A34SIS}}; graded verdict {{LB-E5-chips-verdict}}. Persistence footnote: manufacturing-aggregate mean rho {{LB-E5-persistence-mfg-meanrho-R}} (SPEC-R) / {{LB-E5-persistence-mfg-meanrho-M}} (SPEC-M).*
...
| --- | --- | --- | --- |
| below 75 | {{LB-E6-threshold-bin1-lt75-mean}} | {{LB-E6-specm-bin1-lt75-mean}} | {{LB-E6-threshold-bin1-lt75-n}} |
| 75 to 85 | {{LB-E6-threshold-bin2-75-85-mean}} | {{LB-E6-specm-bin2-75-85-mean}} | {{LB-E6-threshold-bin2-75-85-n}} |
| 85 to 90 | {{LB-E6-threshold-bin3-85-90-mean}} | {{LB-E6-specm-bin3-85-90-mean}} | {{LB-E6-threshold-bin3-85-90-n}} |
| 90 and above | {{LB-E6-threshold-bin4-ge90-mean}} | {{LB-E6-specm-bin4-ge90-mean}} | {{LB-E6-threshold-bin4-ge90-n}} |
...
| --- | --- | --- | --- | --- |
| {{LB-E10-tbl5-r01-country}} | {{LB-E10-tbl5-r01-phi}} | {{LB-E10-tbl5-r01-phiraw}} | {{LB-E10-tbl5-r01-rho}} | {{LB-E10-tbl5-r01-npairs}} |
| {{LB-E10-tbl5-r02-country}} | {{LB-E10-tbl5-r02-phi}} | {{LB-E10-tbl5-r02-phiraw}} | {{LB-E10-tbl5-r02-rho}} | {{LB-E10-tbl5-r02-npairs}} |
| {{LB-E10-tbl5-r03-country}} | {{LB-E10-tbl5-r03-phi}} | {{LB-E10-tbl5-r03-phiraw}} | {{LB-E10-tbl5-r03-rho}} | {{LB-E10-tbl5-r03-npairs}} |
| {{LB-E10-tbl5-r04-country}} | {{LB-E10-tbl5-r04-phi}} | {{LB-E10-tbl5-r04-phiraw}} | {{LB-E10-tbl5-r04-rho}} | {{LB-E10-tbl5-r04-npairs}} |
| {{LB-E10-tbl5-r05-country}} | {{LB-E10-tbl5-r05-phi}} | {{LB-E10-tbl5-r05-phiraw}} | {{LB-E10-tbl5-r05-rho}} | {{LB-E10-tbl5-r05-npairs}} |
| {{LB-E10-tbl5-r06-country}} | {{LB-E10-tbl5-r06-phi}} | {{LB-E10-tbl5-r06-phiraw}} | {{LB-E10-tbl5-r06-rho}} | {{LB-E10-tbl5-r06-npairs}} |
| {{LB-E10-tbl5-r07-country}} | {{LB-E10-tbl5-r07-phi}} | {{LB-E10-tbl5-r07-phiraw}} | {{LB-E10-tbl5-r07-rho}} | {{LB-E10-tbl5-r07-npairs}} |
| {{LB-E10-tbl5-r08-country}} | {{LB-E10-tbl5-r08-phi}} | {{LB-E10-tbl5-r08-phiraw}} | {{LB-E10-tbl5-r08-rho}} | {{LB-E10-tbl5-r08-npairs}} |
| {{LB-E10-tbl5-r09-country}} | {{LB-E10-tbl5-r09-phi}} | {{LB-E10-tbl5-r09-phiraw}} | {{LB-E10-tbl5-r09-rho}} | {{LB-E10-tbl5-r09-npairs}} |
| {{LB-E10-tbl5-r10-country}} | {{LB-E10-tbl5-r10-phi}} | {{LB-E10-tbl5-r10-phiraw}} | {{LB-E10-tbl5-r10-rho}} | {{LB-E10-tbl5-r10-npairs}} |
| {{LB-E10-tbl5-r11-country}} | {{LB-E10-tbl5-r11-phi}} | {{LB-E10-tbl5-r11-phiraw}} | {{LB-E10-tbl5-r11-rho}} | {{LB-E10-tbl5-r11-npairs}} |
| {{LB-E10-tbl5-r12-country}} | {{LB-E10-tbl5-r12-phi}} | {{LB-E10-tbl5-r12-phiraw}} | {{LB-E10-tbl5-r12-rho}} | {{LB-E10-tbl5-r12-npairs}} |
| {{LB-E10-tbl5-r13-country}} | {{LB-E10-tbl5-r13-phi}} | {{LB-E10-tbl5-r13-phiraw}} | {{LB-E10-tbl5-r13-rho}} | {{LB-E10-tbl5-r13-npairs}} |
| {{LB-E10-tbl5-r14-country}} | {{LB-E10-tbl5-r14-phi}} | {{LB-E10-tbl5-r14-phiraw}} | {{LB-E10-tbl5-r14-rho}} | {{LB-E10-tbl5-r14-npairs}} |
| {{LB-E10-tbl5-r15-country}} | {{LB-E10-tbl5-r15-phi}} | {{LB-E10-tbl5-r15-phiraw}} | {{LB-E10-tbl5-r15-rho}} | {{LB-E10-tbl5-r15-npairs}} |
| {{LB-E10-tbl5-r16-country}} | {{LB-E10-tbl5-r16-phi}} | {{LB-E10-tbl5-r16-phiraw}} | {{LB-E10-tbl5-r16-rho}} | {{LB-E10-tbl5-r16-npairs}} |
| {{LB-E10-tbl5-r17-country}} | {{LB-E10-tbl5-r17-phi}} | {{LB-E10-tbl5-r17-phiraw}} | {{LB-E10-tbl5-r17-rho}} | {{LB-E10-tbl5-r17-npairs}} |
| {{LB-E10-tbl5-r18-country}} | {{LB-E10-tbl5-r18-phi}} | {{LB-E10-tbl5-r18-phiraw}} | {{LB-E10-tbl5-r18-rho}} | {{LB-E10-tbl5-r18-npairs}} |


### 9.2 Unemployment Insurance

The pre-registered procyclical-feedback reading fired WITHDRAWN [@Anderson-Meyer-1994; @Woodbury-2004]. The mechanism those studies describe is what the pre-registration expected to find: incomplete experience rating distorts layoff behaviour, and unemployment-insurance tax schedules automatically shift and steepen over the business cycle, so the marginal tax cost of a layoff rises precisely during a recession. That is a feedback channel of exactly the shape this framework measures. The data did not support the reading, and the theoretical literature is in any case not unanimous that experience rating is straightforwardly stabilizing - under implicit-contract wage rigidity its introduction can raise long-term employment and welfare [@Fath-Fuest-2002]. Characterization: pooled normal-period phi {{LB-E11-normal-phi}} (n {{LB-E11-normal-n}}), rho {{LB-E11-normal-rho-min}} to {{LB-E11-normal-rho-max}} across all nine combinations, all below 1; jurisdictions {{LB-E11-normal-jur-phi-min}} to {{LB-E11-normal-jur-phi-max}} (median {{LB-E11-normal-jur-phi-median}}); pooled GFC phi {{LB-E11-gfc-phi}} (n {{LB-E11-gfc-n}}) sits far below the boundary corner {{LB-E11-gfc-corner}} and beside the normal-period pooled estimate {{LB-E11-normal-phi}} - a descriptive comparison, with no formal difference test computed or claimed, and the normal window, excluding only the GFC, contains the 2020 claims shock; reading {{LB-E11-gfc-reading}} - consistent with the cited counterpoint and rhyming with the COVID finding: crises in these systems arrive as level shocks, not persistence explosions.
...
This paper was produced with substantial AI assistance. Claude (Anthropic) served as research assistant and code author under the author's direction and the project's Research-to-Publication Standard: Claude drafted and edited analysis code, ran container-side quality assurance, performed the seven-class code-integrity review, drafted manuscript text from the author's pre-registered outline, and maintained the project's decision journal and verification artifacts. All experiments were pre-registered by the author; all analysis code, its integrity review (verification/cic_signoff.md), and the machine-checked claim ledger are committed alongside this manuscript; every load-bearing number is rendered from that ledger by a committed script. The author made all scientific decisions, ran all analyses locally, verified all results by hash, and takes full responsibility for the content. The adversarial pre-publication review was performed by Claude in a separate, isolated session on the claude.ai web interface with no filesystem access of any kind, started outside any project so that no memory of this work carried into it, and working only from a curated package of committed artifacts assembled by script - the manuscript, the claim ledger, every analysis script and its committed outputs, the specification documents and the proof record, but never the decision journal and never the raw data store - with ten mandated verification passes. Its record: all 506 then-committed ledger rows recomputed with zero mismatches and no wrong number found anywhere; eighteen findings confirmed (fourteen candidate findings withdrawn by the reviewer's own verification), of which sixteen were fixed and two rebutted in writing inside the paper, with every fix and both rebuttals committed under the machine-checked gates; one finding was cured by a pre-registered amendment computing a new uncertainty statistic, whose unresolved result is reported in Section 6.1 exactly as the frozen rule dictates; and one small boundary defect in the primary falsifier's final evaluation point was self-found and disclosed during the round (Section 5.4) rather than surfaced by the reviewer. The reviewer then exercised a second, delta-verification round over the corrected package, independently recomputing the enlarged ledger of 546 rows with zero mismatches and a byte-identical render, and certified the review closed with no further round requested. The full adjudication, the reviewer's findings, and the acknowledgment and certification are committed verbatim in verification/.

One limit on all of the above belongs with it: author and reviewer were both Claude. An isolated session with no access to this work's history can catch oversight - and it caught eighteen things - but it cannot be relied on to catch a blind spot the two sessions share, because the same model reasoning twice may make the same mistake twice. The clearest evidence of that bound is in the review's own record: the one defect found in the primary falsifier was found by the author side executing the code's loop bounds, was invisible from every output the reviewer could reach, and was reported unprompted; the reviewer stated plainly that it could not have found it. A reader weighing the verification record should weigh that asymmetry with it. The forward predictions in Section 11 are the only claims that route around author and reviewer alike, and they remain the strongest validator on offer.

Three process failures during the rebuild are disclosed here because they bear on what this pipeline's checks do and do not guarantee. First, the manuscript reached mid-drafting with no Methods section while every automated gate stayed green: the reconciliation gate compares the manuscript against an outline the same assistant maintained, and a comparison between two artifacts is structurally blind to an omission they share. The cure - a required-section check asserted from a fixed list independent of both artifacts - is now part of the committed verification suite, with a self-test fixture proving it fires. Second, one experiment's pre-registered decision rule was mis-calibrated: an interval-non-overlap test that, measured after the single real run, could not have fired at the effect actually present in the data. The defect was knowable in advance and was not known in advance by author or assistant; the rule's measured sensitivity and a correctly targeted secondary analysis, whose reading was committed before its script existed, are disclosed in Sections 5.6 and 7.1. Third, and different in kind from the other two: during the review round a commit was made while the verification gate was reporting failure, because the runbook step that was supposed to block on the gate read the wrong process's exit status - the renderer's rather than the verifier's - and so reported success. The gate itself worked correctly and its failure was the true state; what failed was the procedure reading it, and the next commit carried the two verifier-side completions the failure had correctly demanded. This one is an operating defect rather than a defect in the published apparatus, and it is recorded because the distinction is easy to lose: a machine-checked gate constrains a paper only as far as the procedure around it reads the gate honestly. Pre-registration constrains what may be claimed; these episodes show it does not by itself guarantee that a check can fail, that a rule can fire, or that a passing report means a passing check, and the verification suite and the commit procedure were each extended to close the specific blindness found.
...
| Estimator comparison (supplementary, not-a-theorem) | - | OLS mean estimate {{LB-T1-estimator-ols}} vs Yule-Walker {{LB-T1-estimator-yw}} (true phi 0.95, n 40); OLS less biased {{LB-T1-estimator-ols-less-biased}} |
...
**Panel B - resolution vs the source's 50-seed record (ar1_high x 2.4x; a regression check, not a calibration; the source's fifty seeds are the first fifty of this paper's 250, so the containment column measures what the added two hundred seeds moved, not agreement between independent runs).**
